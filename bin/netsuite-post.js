...
script = script.replace('define(function() { return /******/ (function(modules) { // webpackBootstrap', 'define(["N/https", "N/log"], function(https, log) { return /******/ (function(modules) { // webpackBootstrap');
